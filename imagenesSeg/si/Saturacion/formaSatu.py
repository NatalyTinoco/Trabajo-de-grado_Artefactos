...
#        plt.imshow(pp)
        ...
        contornos.append(len(contours))
        imageBbox.append(image+'-'+str(c))
        
        
        image2 = image.split('.')
        cv2.imwrite('C:/Users/Usuario/Documents/Daniela/Tesis/Trabajo-de-grado_Artefactos/imagenesSeg/si/Saturacion/'+image2[0]+'-contorno.jpg',im2)
...
dataFra.to_excel('caracterForma_sat.xlsx')
