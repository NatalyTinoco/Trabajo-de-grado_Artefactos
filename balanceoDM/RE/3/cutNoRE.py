...
#            dire='C:/Users/Nataly/Documents/Trabajo-de-grado_Artefactos/balanceoDM/50x50/RE/3/'+image[0:len(image)-3]+'-'+str(re)+'.jpg'
#            cv2.imwrite(dire,cropped)
#            re=re+1
#                
#    print('150x150')
...
#    else:
    for fa in range(0,a-tamañoaA,tamañoaA):
       for ca in range(0,b-tamañoaB,tamañoaB):
            ...
            dire='C:/Users/Nataly/Documents/Trabajo-de-grado_Artefactos/balanceoDM/150x150/RE/3/'+image[0:len(image)-3]+'-'+str(rea)+'.jpg'
            cv2.imwrite(dire,croppeda)
            rea=rea+1
    print('500x500')            
#    tamañoa1A=300
...
#            dire='C:/Users/Nataly/Documents/Trabajo-de-grado_Artefactos/balanceoDM/500x500/RE/3/'+image[0:len(image)-3]+'-'+str(rea1)+'.jpg'
#            cv2.imwrite(dire,croppeda1)
#            rea1=rea1+1
#        print(image)
#   
