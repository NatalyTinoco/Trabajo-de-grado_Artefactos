...
#            dire='C:/Users/Nataly/Documents/Trabajo-de-grado_Artefactos/balanceoDM/50x50/RE/5/'+image[0:len(image)-3]+'-'+str(re)+'.jpg'
#            cv2.imwrite(dire,cropped)
#            re=re+1
#                
#    print('150x150')
...
#            dire='C:/Users/Nataly/Documents/Trabajo-de-grado_Artefactos/balanceoDM/150x150/RE/5/'+image[0:len(image)-3]+'-'+str(rea)+'.jpg'
#            cv2.imwrite(dire,croppeda)
#            rea=rea+1
#    print('500x500')            
    tamañoa1A=300
...
#    else:
    for fa1 in range(0,a-tamañoa1A,tamañoa1A):
       for ca1 in range(0,b-tamañoa1B,tamañoa1B):
            ...
            dire='C:/Users/Nataly/Documents/Trabajo-de-grado_Artefactos/balanceoDM/500x500/RE/5/'+image[0:len(image)-3]+'-'+str(rea1)+'.jpg'
            cv2.imwrite(dire,croppeda1)
            rea1=rea1+1
#        print(image)
#   
