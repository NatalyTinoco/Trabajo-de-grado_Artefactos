...
#datos.to_excel('Caracateristicas_NO_H(S)V_300x300.xlsx') 
#datos.to_excel('Caracateristicas_NO_RG(B)_300x300.xlsx') 
#datos.to_excel('Caracateristicas_NO_Estiramiento_H(S)V_300x300.xlsx') 
datos.to_excel('Caracateristicas_NO_Estiramiento_HS(V)_300x300.xlsx') 