...
for imgfile in glob.glob("*.jpg"):
    ...
    if TTT==0:
       betad=TT[TTT]/sum(TT)
        ...
        betad=sum(TT[0:TTT])/sum(TT)
    betaHOP.append(betad)
    ...
    errorCuadraticoDWHT(mse(WHTr,WHT))
...
#    bb = cv2.GaussianBlur(aa,(5,5),2.5)
    ...
    betaDWHT.append(beta1nor)
    DiferenciaDWHT.append(difnor)
    errorCuadraticoDWHT(mse(bb4,aa4))
    sSIMDWHT.append(ssim(bb4,aa4))
