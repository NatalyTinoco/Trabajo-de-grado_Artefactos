...
#            dire='C:/Users/Nataly/Documents/Trabajo-de-grado_Artefactos/balanceoDM/50x50/DM/4/'+image[0:len(image)-3]+'-'+str(re)+'.jpg'
#            cv2.imwrite(dire,cropped)
#            re=re+1
#                
#    print('150x150')
...
#            dire='C:/Users/Nataly/Documents/Trabajo-de-grado_Artefactos/balanceoDM/150x150/DM/4/'+image[0:len(image)-3]+'-'+str(rea)+'.jpg'
#            cv2.imwrite(dire,croppeda)
#            rea=rea+1
#    print('500x500')            
    tamañoa1A=300
