...
for image in glob.glob('*.jpg'):
    ...
    for f in range(0,a-tamañoA,tamañoA):
       for c in range(0,b-tamañoB,tamañoB):
            ...
            dire='C:/Users/Nataly/Documents/Trabajo-de-grado_Artefactos/balanceoDM/50x50/NO/8/'+image[0:len(image)-3]+'-'+str(re)+'.jpg'
    ...
    for fa in range(0,a-tamañoaA,tamañoaA):
       for ca in range(0,b-tamañoaB,tamañoaB):
            ...
            dire='C:/Users/Nataly/Documents/Trabajo-de-grado_Artefactos/balanceoDM/150x150/NO/8/'+image[0:len(image)-3]+'-'+str(rea)+'.jpg'
    ...
    for fa1 in range(0,a-tamañoa1A,tamañoa1A):
       for ca1 in range(0,b-tamañoa1B,tamañoa1B):
            ...
            dire='C:/Users/Nataly/Documents/Trabajo-de-grado_Artefactos/balanceoDM/500x500/NO/8/'+image[0:len(image)-3]+'-'+str(rea)+'.jpg'
