...
#datos.to_excel('Caracateristicas_DM_HS(V)_50x50.xlsx') 
#datos.to_excel('Caracateristicas_DM_H(S)V_50x50.xlsx') 
datos.to_excel('Caracateristicas_DM_RG(B)_50x50.xlsx') 
#datos.to_excel('Caracateristicas_DM_(HSV)Grey_50x50.xlsx') 
#datos.to_excel('Caracateristicas_DM_Estiramiento_H(S)V_50x50.xlsx') 
#datos.to_excel('Caracateristicas_DM_Estiramiento_HS(V)_50x50.xlsx') 
