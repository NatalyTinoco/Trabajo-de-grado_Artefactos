...
#datos.to_excel('Caracateristicas_RE_HS(V)_50x50.xlsx') 
#datos.to_excel('Caracateristicas_RE_H(S)V_50x50.xlsx') 
datos.to_excel('Caracateristicas_RE_RG(B)_50x50.xlsx') 
#datos.to_excel('Caracateristicas_RE_(HSV)Grey_50x50.xlsx') 
#datos.to_excel('Caracateristicas_RE_Estiramiento_H(S)V_50x50.xlsx') 
#datos.to_excel('Caracateristicas_RE_Estiramiento_HS(V)_50x50.xlsx') 
