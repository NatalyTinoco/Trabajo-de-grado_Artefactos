...
#datos.to_excel('Caracateristicas_DM_HS(V)_150x150.xlsx') 
#datos.to_excel('Caracateristicas_DM_H(S)V_150x150.xlsx') 
#datos.to_excel('Caracateristicas_DM_RG(B)_150x150.xlsx') 
#datos.to_excel('Caracateristicas_DM_(HSV)Grey_150x150.xlsx') 
#datos.to_excel('Caracateristicas_DM_Estiramiento_H(S)V_150x150.xlsx') 
datos.to_excel('Caracateristicas_DM_Estiramiento_HS(V)_150x150.xlsx') 
