...
file = r'C:/Users/Nataly/Documents/Trabajo-de-grado_Artefactos/balanceoDM/150x150/RE/Caracateristicas_RE_Estiramiento_HS(V)_150x150.xlsx'
...
filed = r'C:/Users/Nataly/Documents/Trabajo-de-grado_Artefactos/balanceoDM/150x150/DM/Caracateristicas_DM_Estiramiento_HS(V)_150x150.xlsx'
...
filen = r'C:/Users/Nataly/Documents/Trabajo-de-grado_Artefactos/balanceoDM/150x150/NO/Caracateristicas_NO_Estiramiento_HS(V)_150x150.xlsx'
...
#    plt.ylabel(tabla[z])
    ...
    f.savefig('C:/Users/Nataly/Documents/Trabajo-de-grado_Artefactos/balanceoDM/150x150/'+'boxplot_Estiramiento_HS(V)'+ str(tabla[z]))
    plt.close()
    plt.show()
import pandas as pd    
...
datos.to_excel('métricasSeparabilidad_Estiramiento_HS(V)_150x150.xlsx')         
