...
#datos.to_excel('Caracateristicas_NO_HS(V)_150x150.xlsx') 
#datos.to_excel('Caracateristicas_NO_H(S)V_150x150.xlsx') 
#datos.to_excel('Caracateristicas_NO_RG(B)_150x150.xlsx') 
#datos.to_excel('Caracateristicas_NO_(HSV)Grey_150x150.xlsx') 
#datos.to_excel('Caracateristicas_NO_Estiramiento_H(S)V_150x150.xlsx') 
datos.to_excel('Caracateristicas_NO_Estiramiento_HS(V)_150x150.xlsx') 