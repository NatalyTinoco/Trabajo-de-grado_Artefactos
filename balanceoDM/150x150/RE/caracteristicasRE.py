...
#datos.to_excel('Caracateristicas_RE_HS(V)_150x150.xlsx') 
#datos.to_excel('Caracateristicas_RE_H(S)V_150x150.xlsx') 
#datos.to_excel('Caracateristicas_RE_RG(B)_150x150.xlsx') 
#datos.to_excel('Caracateristicas_RE_(HSV)Grey_150x150.xlsx') 
#datos.to_excel('Caracateristicas_RE_Estiramiento_H(S)V_150x150.xlsx') 
datos.to_excel('Caracateristicas_RE_Estiramiento_HS(V)_150x150.xlsx') 
