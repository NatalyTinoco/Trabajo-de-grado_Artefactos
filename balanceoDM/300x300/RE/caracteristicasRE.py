...
#datos.to_excel('Caracateristicas_RE_H(S)V_300x300.xlsx') 
#datos.to_excel('Caracateristicas_RE_RG(B)_300x300.xlsx') 
#datos.to_excel('Caracateristicas_RE_((H)SV)_300x300.xlsx') 
#datos.to_excel('Caracateristicas_RE_Estiramiento_H(S)V_300x300.xlsx') 
datos.to_excel('Caracateristicas_RE_Estiramiento_HS(V)_300x300.xlsx') 
