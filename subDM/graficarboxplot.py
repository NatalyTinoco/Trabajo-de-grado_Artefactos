...
workbook = xlrd.open_workbook("metricasDistancia.xlsx")
...
for fil in range(2,168):
    ...
    rgb[i]=sheet.cell_value(fil, 9)
    LCN[i]=sheet.cell_value(fil, 12)
    Inte[i]=sheet.cell_value(fil, 15)
    Estand[i]=sheet.cell_value(fil, 18)
    Log[i]=sheet.cell_value(fil, 21)
...
for fil in range(2,168):
    ...
    rgb[i]=sheet.cell_value(fil, 8)
    LCN[i]=sheet.cell_value(fil, 11)
    Inte[i]=sheet.cell_value(fil, 14)
    Estand[i]=sheet.cell_value(fil, 17)
    Log[i]=sheet.cell_value(fil, 20)
...
for fil in range(2,168):
    ...
    rgb[i]=sheet.cell_value(fil, 7)
    LCN[i]=sheet.cell_value(fil, 10)
    Inte[i]=sheet.cell_value(fil, 13)
    Estand[i]=sheet.cell_value(fil, 16)
    Log[i]=sheet.cell_value(fil, 19)
