...
Descripción del código: Función donde se extraen las características SODMS encontrada como SSIMN (valor SSIM entre la imagen sin y con suavizado) 
y entropía nombrada entropia3(característica de textura a partir de la matriz GLCM)
...
def GLCM (imA):
    ...
    disimi=skimage.feature.greycoprops(g, 'dissimilarity') 
