...
Descripción del código: Función de la umbralización de posibles reflejos especualres, basada en el calculo del histograma en el canal G (RGB), toma como umbral el punto donde la derivada
del histograma cambia de un valor grande a uno cercano a cero, da como resultado una mascara binaria nombrada close.
