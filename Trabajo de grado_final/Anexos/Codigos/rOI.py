...
Descripción del código: Función donde se extrae la ROI (Región de interes) a partir del calculo del histograma en el canal Z del espacio de color XYZ, 
entrega como resultado una mascara binaria nombrada close.
