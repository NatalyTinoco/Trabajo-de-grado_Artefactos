...
file = r'C:/Users/Usuario/Documents/Daniela/Tesis/Trabajo-de-grado_Artefactos/balanceoRE/bbox/RE/Características_brilloRE.xlsx'
dfRE = pd.read_excel(file)
filed = r'C:/Users/Usuario/Documents/Daniela/Tesis/Trabajo-de-grado_Artefactos/balanceoRE/bbox/DM/Características_brilloDM.xlsx'
dfDM = pd.read_excel(filed)
filen = r'C:/Users/Usuario/Documents/Daniela/Tesis/Trabajo-de-grado_Artefactos/balanceoRE/bbox/NO/Características_brilloNO.xlsx'
...
tabla=['Brillo','Luminancia','entropia']

#file2 = r'C:/Users/Nataly/Documents/Trabajo-de-grado_Artefactos/balanceoDM/500x500/RE/Caracateristicas_RE_H(S)V_300x300.xlsx'
#dfRE2 = pd.read_excel(file2)
#filed2 = r'C:/Users/Nataly/Documents/Trabajo-de-grado_Artefactos/balanceoDM/500x500/DM/Caracateristicas_DM_H(S)V_300x300.xlsx'
#dfDM2 = pd.read_excel(filed2)
#filen2 = r'C:/Users/Nataly/Documents/Trabajo-de-grado_Artefactos/balanceoDM/500x500/NO/Caracateristicas_NO_H(S)V_300x300.xlsx'
#dfNO2 = pd.read_excel(filen2)


#file3 = r'C:/Users/Nataly/Documents/Trabajo-de-grado_Artefactos/balanceoDM/500x500/RE/Caracateristicas_RE_RG(B)_300x300.xlsx'
#dfRE3 = pd.read_excel(file3)
#filed3 = r'C:/Users/Nataly/Documents/Trabajo-de-grado_Artefactos/balanceoDM/500x500/DM/Caracateristicas_DM_RG(B)_300x300.xlsx'
#dfDM3= pd.read_excel(filed3)
#filen3 = r'C:/Users/Nataly/Documents/Trabajo-de-grado_Artefactos/balanceoDM/500x500/NO/Caracateristicas_NO_RG(B)_300x300.xlsx'
...
#    NO3=dfNO3[tabla[z]]
    ...
    statDRmis,pDRmis= wilcoxon(DM,RE)
    ...
    statRNmis,pRNmis=wilcoxon(RE,NO)
    ...
    statDNmis,pDNmis= wilcoxon(DM,NO)
...
#    plt.ylabel(tabla[z])
    ...
    f.savefig('C:/Users/Usuario/Documents/Daniela/Tesis/Trabajo-de-grado_Artefactos/balanceoRE/bbox/'+'boxplot_'+ str(tabla[z]))
    plt.close()
    plt.show()
import pandas as pd    
datos = {'Cracteristica':tabla,
         ...
         'DM vs RE (p) WILCONXON ': pDRgmis,
         'DM vs NO (p)  WILCONXON ': pDNgmis,
         'RE vs NO (p)  WILCONXON ':pRNgmis,
         'DM vs RE (Stat) WILCONXON ': statDRgmis,
         'DM vs NO (Stat) WILCONXON ': statDNgmis,
         'RE vs NO (Stat) WILCONXON ':statRNgmis,
...
datos.to_excel('métricasBrilloRE.xlsx')         
