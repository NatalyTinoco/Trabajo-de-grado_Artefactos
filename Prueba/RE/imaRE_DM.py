...
#    image='00317.jpg'
    ...
    for b in boxes_abs:
            ...
            if cls == 3:
                ...
                dire1='C:/Users/Nataly/Documents/Trabajo-de-grado_Artefactos/Prueba/cutparaDM/DM/'+str(dm)+image
                cv2.imwrite(dire1,cropped1) 
            if cls==0:
                re=re+1
                cropped2 = im[int(y1):int(y2),int(x1):int(x2)]
                dire1='C:/Users/Nataly/Documents/Trabajo-de-grado_Artefactos/Prueba/cutparaRE/RE/'+str(re)+image
