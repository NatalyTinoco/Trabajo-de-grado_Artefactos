...
qtCreatorFile = "Artefactos_Final.ui" #Aquí va el nombre de tu archivo
...
class MyApp(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def seleccionarImagen(self):
        ...
        filePath, _ = QtWidgets.QFileDialog.getOpenFileName(self, 'Open file', './Trabajo-de-grado_Artefactos/Prueba/',formats)
...
#            self.labe_2.clear()
        ...
        print (len(grupo0),len(grupo1),len(grupodm0),len(grupodm1))
