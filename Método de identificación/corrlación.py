...
file=r'C:\Users\Nataly\Documents\Trabajo-de-grado_Artefactos\Caracteristicas\DM\Caracateristicas_DM_H(S)V_300x300.xlsx'
datos= pd.read_excel(file)
corr1=datos.corr()
datos = pd.DataFrame({corr1})
datos = pd.DataFrame(datos)
datos.to_excel('CorrelacióncaracteristicasDM.xlsx')    
