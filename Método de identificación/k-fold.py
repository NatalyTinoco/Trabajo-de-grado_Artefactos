...
#    f.savefig('C:/Users/Nataly/Documents/Trabajo-de-grado_Artefactos/Método de identificación/DM/k-Fold/'+'ROC'+ str(nombre))
...
datos.to_excel('k-fold_DM_PROMEDIO_binaria_balanceo7.xlsx')     
#%%
...
datos = pd.DataFrame(datos)
datos.to_excel('k-fold_DM_binaria_balanceo7.xlsx') 
