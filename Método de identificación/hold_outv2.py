...
def medidas(y_test,y_predictions,nombre):
    ...
    f.savefig('C:/Users/Nataly/Documents/Trabajo-de-grado_Artefactos/Método de identificación/DM/holdOUT/'+'ROC_BALANCEO2_a'+ str(nombre))
#    f.savefig('C:/Users/Nataly/Documents/Trabajo-de-grado_Artefactos/Método de identificación/RE/holdOUT/'+'ROC_BALANCEO2_a'+ str(nombre))
    plt.close()
    plt.show()
    return []
#%%
...
datos.to_excel('holdOut_DM_binaria_balanceo2a.xlsx') 
#datos.to_excel('holdOut_RE_binaria_balanceo2a.xlsx')         
"""#%%
...
sensibilidad=recall_score(y_test,y_predictions)
puntaje=f1_score(y_test,y_predictions)
puntajeroc=roc_auc_score(y_test,y_predictions)
fpr, tpr, thresholds = roc_curve(y_test, y_predictions)
roc_auc = auc(fpr, tpr)
#%%
plt.figure()
