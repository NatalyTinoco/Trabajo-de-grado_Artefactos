...
TA=['DM_1','DM_2','DM_3','RE_1','RE_2','RE_3']

for TAB in TA:
        
    file = r'C:\Users\Nataly\Documents\Trabajo-de-grado_Artefactos\Método de identificación\UNIÓN DE CARACTERISTICAS\binario'+TAB+'.xlsx'
    ...
    #%%
        ...
        datos.to_excel('k-fold_'+TAB+'_PROMEDIO'+'run'+str(lac)+'.xlsx')     
        #%%
        ...
        datos = pd.DataFrame(datos)
        datos.to_excel('k-fold_'+TAB+'run'+str(lac)+'.xlsx') 
#%%
nombree=[]
promedio=[],[],[],[],[],[],[],[],[],[]
h=[]
...
for TAB in TA:
    for lac in range(10):
        file=r'C:\Users\Nataly\Documents\Trabajo-de-grado_Artefactos\Método de identificación\UNIÓN DE CARACTERISTICAS\k-fold_'+TAB+'_PROMEDIO'+'run'+str(lac)+'.xlsx'     
        datos= pd.read_excel(file)   
    ...
    datosm.to_excel('k-fold_'+TAB+'_PROMEDIOTENFOLD.xlsx')     
