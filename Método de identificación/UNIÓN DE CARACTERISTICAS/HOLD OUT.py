...
file = r'C:\Users\Nataly\Documents\Trabajo-de-grado_Artefactos\Método de identificación\UNIÓN DE CARACTERISTICAS\binarioDM_sSIMN.xlsx'
...
datos.to_excel('holdOut_solosSIMN.xlsx') 
#    datos.to_excel('holdOut_'+TAB+'.xlsx') 
